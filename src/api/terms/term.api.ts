...
export class TermApi extends AxiosApi {
    ...
    async assignImages(params: Terms.AssignImagesCommand) {
        return this.post(`${this.baseUrl}/assign-images`, params)
    }
    ...
    async updateChildInfoBlock(
        command: TermContracts.UpdateTermChildInfoBlockCommand
    ) {
