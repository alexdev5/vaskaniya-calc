<template>
    ...
    >
        <draggable
            ...
            @end="
                dragTerm($event, {
                    parentId: store.state.parentTerm!.id,
        ...
        >
            <template #item="{ element }">
                <VsBlockCard
                    :class="{
                        active:
                            element.id === store.state.selectedProductTypeId,
                    ...
                    "
                    @duplicated="
                        duplicateTerm(element.id, store.state.taxonomy)
                    "
            ...
            <template #item="{ element }">
                <VsBlockCard
                    ...
                    :class="{
                        'is-term-visibility': element.acf.isHidden,
                        active:
                            element.id === store.state.selectedConfigurationId,
                    }"
                    :record="element"
                    :deleteLoading="store.imageDeleting"
                    :loading="progress.savingCardSettings"
